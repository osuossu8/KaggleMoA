...
#train_features = pd.concat((train_features, train_features_cluster), axis=1)
#test_features = pd.concat((test_features, test_features_cluster), axis=1)
